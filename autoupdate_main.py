...
def update(version: str):
    url = "https://github.com/uberith/Microsoft-Rewards-Farmer/archive/refs/heads/master.zip"
...
def getLatestVersion():
    r = requests.get(
        "https://api.github.com/repos/uberith/Microsoft-Rewards-Farmer/commits/master"
    )
    return r.json()["sha"]
